...
const retryScan = async () => {
 ...
 onMounted(async () => {
  ...
  const resetWizard = () => {
    console.log('Resetting wizard and clearing stored settings...');
    ...
    store.dispatch('suseai/setSelectedCluster', '');
    store.dispatch('suseai/setSelectedPod', null);
    ...
    // Reset selection to all accessible clusters
    selectedClusters.value = [...accessibleClusters.value];
